...
{
    /// <summary>
    /// Клас для реализации биндинга и INotifyPropertyChanged, INotifyPropertyChanging
    /// </summary>
	public class Bindable : INotifyPropertyChanged, INotifyPropertyChanging
    {
        ...
        /// NotifyPropertyChangedInvocator - метка решарперу, что есть ошибка в именовании 
        /// </summary>
